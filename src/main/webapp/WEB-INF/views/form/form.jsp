...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <%--Dodaję obsługę metody post, żeby przenosiło do adresu--%>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        <h4>Adres odbioru</h4>
                        <div class="form-group form-group--inline">
                            <label> Ulica <input type="text" name="street" value="${donation.street}" id="street"/>
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Miasto <input type="text" name="city" value="${donation.city}" id="city"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>
                                Kod pocztowy <input type="text" name="zipCode" value="${donation.zipCode}"
                                                    id="zipCode"/>
                            </label>
                        </div>
                            <%--My nie mamy numeru telefonu--%>
                            <%--                        <div class="form-group form-group--inline">--%>
                            <%--                            <label>--%>
                            <%--                                Numer telefonu <input type="phone" name="phone" value="${donation.}"/>--%>
                            <%--                            </label>--%>
                            <%--                        </div>--%>
                    </div>
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            ...
                            <%--Tutaj cośtrzeba będzie zmeinić--%>
                        <div class="form-group form-group--inline">
                            <label>
                                Uwagi dla kuriera
                                <textarea name="pickUpComment" rows="5" path="pickUpComment"
                                          id="pickUpComment"></textarea>
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="summary--text">Dla Fundacji
                                    <span id="institutionSummary"></span>
                                </span
                                >
                            </li>
                        </ul>
